...
class Mainpanel : Window
{
   ...
   HTMLView htmlview { picture1, this, opacity = 0, visible = true, drawBehind = false, borderStyle = none, size = { 491, 635 }, position = { 112, 72 }  };
   Console console   { picture1, this, opacity = 0, drawBehind = true, size = { 493, 635 }, position = { 112, 72 }, editTextColor = white, font = { "Comic Sans MS", 10 }; 
 
       bool ProcessCommand(char * command)
       {        
          chatFile.Seek(0, end);
          chatFile.PrintLn(command);
          chatFile.Seek(0,start); mainpanel.htmlview.OpenFile(chatFile, null);
   ...
   Picture picture20 { picture1, this, "smiley19", size = { 17, 17 }, position = { 936, 680 }, toolTip = " :haha ",    image = { ":smiley19.gif" }; };
   Picture picture19 { picture1, this, "smiley18", size = { 17, 17 }, position = { 912, 680 },toolTip = " :dead  ",    image = { ":smiley18.gif" }; };
   Picture picture18 { picture1, this, "smiley17", size = { 17, 17 }, position = { 888, 680 },toolTip = " :disgust ",  image = { ":smiley17.gif" }; };
   Picture picture17 { picture1, this, "smiley16", size = { 17, 17 }, position = { 864, 680 },toolTip = " :tired ",    image = { ":smiley16.gif" }; };
   Picture picture16 { picture1, this, "smiley15", size = { 17, 17 }, position = { 840, 680 },toolTip = " :cheeky ",   image = { ":smiley15.gif" }; };
   Picture picture15 { picture1, this, "smiley14", size = { 17, 17 }, position = { 816, 680 },toolTip = " :cry ",      image = { ":smiley14.gif" }; };
   Picture picture14 { picture1, this, "smiley13", size = { 17, 17 }, position = { 792, 680 },toolTip = " :sick ",     image = { ":smiley13.gif" }; };
   Picture picture13 { picture1, this, "smiley12", size = { 17, 17 }, position = { 768, 680 },toolTip = " :$ ",        image = { ":smiley12.gif" }; };
   Picture picture12 { picture1, this, "smiley11", size = { 17, 17 }, position = { 744, 680 },toolTip = " :cool ",     image = { ":smiley11.gif" }; };
   Picture picture11 { picture1, this, "smiley10", size = { 17, 17 }, position = { 720, 680 },toolTip = " :D ",        image = { ":smiley10.gif" }; };
   Picture picture10 { picture1, this, "smiley9",  size = { 17, 17 }, position = { 696, 680 },toolTip = " :S ",        image = { ":smiley9.gif"  }; };
   Picture picture9  { picture1, this, "smiley8",  size = { 17, 17 }, position = { 864, 656 },toolTip = " :P ",        image = { ":smiley8.gif"  }; };
   Picture picture8  { picture1, this, "smiley7",  size = { 17, 17 }, position = { 840, 656 },toolTip = " :O ",        image = { ":smiley7.gif"  }; };
   Picture picture7  { picture1, this, "smiley6",  size = { 17, 17 }, position = { 816, 656 },toolTip = " :confused ", image = { ":smiley6.gif"  }; };
   Picture picture6  { picture1, this, "smiley5",  size = { 17, 17 }, position = { 792, 656 },toolTip = " :< ",        image = { ":smiley5.gif"  }; };
   Picture picture5  { picture1, this, "smiley4",  size = { 17, 17 }, position = { 768, 656 },toolTip = " :/ ",        image = { ":smiley4.gif"  }; };
   Picture picture4  { picture1, this, "smiley3",  size = { 17, 17 }, position = { 744, 656 },toolTip = " ;) ",        image = { ":smiley3.gif"  }; };
   Picture picture3  { picture1, this, "smiley2",  size = { 17, 17 }, position = { 720, 656 },toolTip = " :( ",        image = { ":smiley2.gif"  }; };
   Picture picture2  { picture1, this, "smiley1",  size = { 17, 17 }, position = { 696, 656 },toolTip = " :) ",        image = { ":smiley1.gif"  }; };
   ProgressBar progressBar1  { picture1, this, "progressBar1", opacity = 0, borderStyle = contour, size = { 585, 23 }, position = { 104, 42 };     };

   Picture picture1
   {
      this, caption = "picture1", inactive = false, position = {  }, image = { ":chat-window20.png" };
  ...
  //       if(x > 665 && x < 731 && y > 649 && y < 678) { chatFile.Seek(0,start); mainpanel.htmlview.OpenFile(chatFile, null); }           
      ...
      bool OnMouseMove(int x, int y, Modifiers mods)
   {
      ...
      bool OnCreate(void)
   {
      //   File f = FileOpen("chat.html", read);
      //   mainpanel.htmlview.OpenFile(f,null);
       //  delete f;
      //          File f = FileOpen(chatFile, read);
     //    mainpanel.htmlview.OpenFile(f, null);
